...
class GamePage:
    ...
    def open_game_window(self):
        ...
        for i in range(12):
            tile_label = tk.Label(tiles_frame, text="", bg='white', width=8, height=4, borderwidth=1, relief="raised")
        ...
        # Hint label
        hint_label = tk.Label(bottom_frame, text="Hint: ")
        hint_label.grid(row=0, column=0, sticky='nsew', padx=(10, 5), pady=(5, 5))
